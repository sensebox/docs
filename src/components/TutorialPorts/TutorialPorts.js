...
// MCU Mini Ports
import i2cPortMini from '@site/static/img/mini/ports/i2c-wire-port.png'
import uartPortMini from '@site/static/img/mini/ports/uart-serial-port.png'
import ioPortMini from '@site/static/img/mini/ports/io-port.png'
// Top-down Images
import mcutop from '@site/static/img/mcu/ports/mcutop.png'
import mcus2top from '@site/static/img/mcus2/mcus2top.png'
import miniTop from '@site/static/img/mini/mini_double.png'
