...
Das Spiel nutzt den integrierten Beschleunigungs-Sensor zur Steuerung und das OLED Display zur Anzeige.
...
## Spielsteuerung
Das Spiel wird mit dem Beschleunigungs-Sensor der senseBox MCU-S2 gesteuert. Schüttel die senseBox, um das Spiel zu starten.
...
<ImageWithText
  ...
  alt="Steuerung des Brick Breaker Spiels mit Hilfe des eingebauten Accelerometers"
  title="Accelerometer Steuerung"
/>
