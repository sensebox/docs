...
<div className="flex flex-row justify-evenly">
  <Popover>
    <PopoverTrigger lassName="flex cursor-pointer bg-white dark:bg-gray-800 text-black dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-md w-[10rem] p-2 hover:bg-gray-100 dark:hover:bg-gray-700">
      I2C/Wire Ports
    </PopoverTrigger>
    <PopoverContent>
      <div>
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="flex flex-col items-center">
            <img src={lightSensor} alt="Your Image" className="w-[5rem] lg:w-[10rem]" />
            <p className="text-gray-500">Lichtsensor</p>
          </div>
          <div className="flex flex-col items-center">
            <img src={tempSensor} alt="Your Image" className="w-[5rem] lg:w-[10rem]" />
            <p className="text-gray-500">Temperatur und Luftfeuchte</p>
          </div>
          <div className="flex flex-col items-center">
            <img src={pressureSensor} alt="Your Image" className="w-[5rem] lg:w-[10rem]" />
            <p className="text-gray-500">Luftdruck</p>
          </div>
          <div className="flex flex-col items-center">
            <img src={tofSensor} alt="Your Image" className="w-[5rem] lg:w-[10rem]" />
            <p className="text-gray-500">Time of Flight(Tof)</p>
          </div>
          <div className="flex flex-col items-center">
            <img src={umweltsensor} alt="Your Image" className="w-[5rem] lg:w-[10rem]" />
            <p className="text-gray-500">Umweltsensor</p>
          </div>
          <div className="flex flex-col items-center">
            <img src={CO2Sensor} alt="Your Image" className="w-[5rem] lg:w-[10rem]" />
            <p className="text-gray-500">CO2-Sensor</p>
          </div>
          <div className="flex flex-col items-center">
            <img src={display} alt="Your Image" className="w-[5rem] lg:w-[10rem]" />
