        ...
        {activeBottomTab === "Hardware" && (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 py-8">
              ...
              />
              <NavBlocks
                href="/docs/hardware/sensors/photodiode"
                title="Photodiode"
              />
              <NavBlocks
              ...
              />
              <NavBlocks
                href="/docs/hardware/sensors/tof"
              ...
              />
              <NavBlocks
                href="/docs/hardware/accessoires/rgb-led-esp32"
                title="ESP32 RGB-LED"
              />
              <NavBlocks
                href="/docs/hardware/accessoires/led-matrix"
                title="LED-Matrix"
              />
              <NavBlocks
