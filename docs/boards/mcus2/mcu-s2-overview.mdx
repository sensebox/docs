        ...
        {activeBottomTab === "Hardware" && (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 py-8">
              ...
              />
              <NavBlocks
                href="/docs/hardware/sensors/tof?board=edus2"
              ...
              />
              <NavBlocks
                href="/docs/hardware/accessoires/rgb-led-esp32?board=edus2"
                title="ESP32 RGB-LED"
              />
              <NavBlocks
                href="/docs/hardware/accessoires/led-matrix?board=edus2"
                title="LED-Matrix"
              />
              <NavBlocks
