    ...
    <PortItem src={ledMatrix} name="LED-Matrix" />
      ...
      {activeBottomTab === 'Hardware' && (
          <>
           ...
           <ImageWithText src={portsOnboardWhite} title="Anschlüsse und Komponenten der Eye" />
            </div>
