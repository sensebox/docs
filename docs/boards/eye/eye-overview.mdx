    ...
    <PortItem src={ledMatrix} name="LED-Matrix" />
      ...
      {activeBottomTab === 'Hardware' && (
          <>
           ...
           <ImageWithText src={portsOnboardWhite} title="Anschlüsse und Komponenten der MCU Eye" />
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 py-8">
                          <NavBlocks href="/docs/hardware/eye/camera" title="Kamera" />
              <NavBlocks href="/docs/hardware/eye/icm20948" title="Beschleunigungssensor" />
              <NavBlocks href="/docs/hardware/eye/rgb-led-esp32" title="RGB-LED" />
