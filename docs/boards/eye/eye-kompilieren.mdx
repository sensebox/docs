...
<div>
  ...
  <p>
    {" "}
    Schließe nun deine senseBox MCU Eye mit Hilfe des USB-Kabels an deinen Computer
  ...
  <AlertBox type="warning" title="Lange Übertragungsdauer!">
    <p>Momentan kann die Übertragung einer .bin Datei auf die senseBox noch etwas länger dauern. Der Übertragunsvorgang ist vollständig abgeschlossen, wenn die LED kurz grün blinkt!</p>
  </AlertBox>
