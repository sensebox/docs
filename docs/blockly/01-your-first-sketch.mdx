...
4. **Kopieren, kompilieren und andere Funktionen von Blockly:**
   Hier findest du den wohl wichtigsten Knopf für Blockly. Mit dem orangen 'Kompilieren' Knopf kannst du deinen erstellten Sketch kompilieren & herunterladen. Darüber hinaus kannst du hier deinen Sketch umbenennen, herunterladen, teilen, Screenshots erstellen oder den Arduino Quellcode deines Sketches in die Zwischenablage speichern.
5. **Arduino Quellcode und XML Blöcke:**
   Hier wird dir parallel zur grafischen Programmierung der Arduino Quellcode angezeigt. Durch einen Klick auf die Schaltfläche XML Blöcke lässt sich die Ansicht auf den XML Code umschalten.
...
Nachdem dein Programm fertig ist, klickst du den orangen "Sketch kompilieren" Button und es wird dir eine .BIN-Datei zum Download angeboten. Diese musst du an einem beliebigen Ort speichern.
