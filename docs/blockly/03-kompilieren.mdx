...
<AlertBox type="warning" title="Lange Übertragungsdauer!" description="Momentan kann die Übertragung einer .bin Datei auf die senseBox noch etwas länger dauern. Der Übertragunsvorgang ist vollständig abgeschlossen, wenn die LED grün leuchtet!" />
