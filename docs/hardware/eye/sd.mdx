...
import sdModul from '@site/static/img/eye/SD.png'
...
<ImageWithText
  ...
  size="xl"
  alt="SD Modul"
  title="Das SD Modul findest du hier auf der Rückseite der MCU Eye"
/>{' '}

Mit der senseBox kannst du Daten auf einer microSD-Karte speichern, um sie später am Computer auszuwerten.

:::success Modul onBoard
Das SD-Modul ist auf der MCU Eye verbaut! Du musst hier also nichts weiter anschließen.
:::
