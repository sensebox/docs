...
<ImageWithText size="xl" src={icm20948} title="ICM20948 auf der MCU Eye verbaut" />

:::success Hinweis
Der Beschleunigungssensor ist auf der MCU Eye verbaut! Du musst hier also nichts weiter anschließen.
:::
