...
<p>Lade dir die <a href="https://github.com/sensebox/Adafruit_CircuitPython_SPS30/releases/download/0.0.1/adafruit-circuitpython-sps30-10.x-mpy-0.0.1.zip">SPS30 CircuitPython Bibliothek</a> herunter. Entpacke die .zip Datei und kopiere den <code>adafruit_sps30</code> Ordner aus dem <code>lib</code> Ordner in den <code>lib</code> Ordner deiner senseBox (<code>CIRCUITPY</code> Laufwerk).</p>
