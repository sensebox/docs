...
:::warning
Um den Sensor mit der senseBox zu benutzen benötigst du zusätzlich den 1-Wire-Adapter. Diesen kannst du [hier](https://sensebox.kaufen/products/sensebox-one-wire-adapter-fur-wasserthermometer) erwerben.
:::
