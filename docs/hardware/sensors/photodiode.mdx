...
<ImageWithText src={photodiode} title="Photodiode auf der MCU verbaut" />

:::success Hinweis
Die Photodiode ist auf der MCU S2 verbaut! Du musst hier also nichts weiter anschließen.
:::
