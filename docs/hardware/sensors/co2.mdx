...
Die kompilierte `.bin` Datei kann [hier](https://github.com/sensebox/docs.sensebox.de/raw/refs/heads/master/docs/sensebox_co2_calibrate_manual.bin) heruntergeladen werden.
