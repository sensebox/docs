...
:::info
Der DPS310 ersetzt den Luftdruck und Temperatursensor BMP280. Welchen von beiden Sensoren du hast kannst du an der Aufschrift auf dem Sensor erkennen, solltest du die Dokuemntation für den BMP280 benötigen findest du diese [hier](/docs/hardware/sensors/luftdruck-temperatur/luftdruck-temperatur-bmp280).
:::
