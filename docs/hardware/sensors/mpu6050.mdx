...
<p>Um den Sensor mit CircuitPython zu programmieren, muss die senseBox MCU-S2.1 zunächst mit CircuitPython geflasht werden. Eine Anleitung dazu findest du <a href="https://docs.sensebox.de/docs/misc/circuitpython_esp32">hier</a>.</p>
