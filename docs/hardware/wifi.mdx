...
hide_title: false
---
import wifiModul from "@site/static/img/mcus2/mcus2top.png"
import  AlertBox from "@site/src/components/AlertBox/AlertBox";
import ImageWithText  from "@site/src/components/ImageWithText/ImageWithText"

# WiFi-Modul
<ImageWithText src={wifiModul} alt="SD Modul" title="Das WiFi Modul ist auf dem Board direkt mittig verbaut."/> 
...
<AlertBox type="success" title="Modul onBoard!">
  <p>Das WiFi-Modul ist auf der MCU S2 verbaut! Du musst hier also nichts weiter anschließen.</p>
</AlertBox>
