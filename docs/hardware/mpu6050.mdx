...
<AlertBox type="success" title="Sensor onBoard!" description="Der Beschleunigungssensor ist auf der MCU S2 verbaut! Du musst hier also nichts weiter anschließen." />
