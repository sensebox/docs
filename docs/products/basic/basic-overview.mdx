...
<NavGreen
      ...
      <div className={activeBottomTab === "Materialien" ? "" : "hidden"}>
        <div className="py-8">
          <div className="mb-8">
      ...
      <div className={activeBottomTab === "Hardware" ? "" : "hidden"}>
         <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            />
            <NavBlocks
              href="/docs/hardware/sensors/umweltsensor/umweltsensor"
              title="Umweltsensor"
            />
      ...
      <div className={activeBottomTab === "Technische Daten" ? "" : "hidden"}>
          <TechSpecs
            name="MCU2"
            sku="SB-105"
