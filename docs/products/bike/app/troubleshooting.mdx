...
## App kann keine Verbindung zur senseBox:bike herstellen:
...
## App startet keine Track-Aufzeichnung (keine Sensordaten und kein Track auf der Karte):
...
## Die App zeichnet den Track lokal auf, lädt ihn aber nicht auf openSenseMap hoch.
...
## Nicht alle Sensordaten werden aufgezeichnet.
