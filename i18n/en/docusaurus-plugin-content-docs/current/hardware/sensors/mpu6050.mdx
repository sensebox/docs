...
<p>To program the sensor with CircuitPython, the senseBox MCU-S2.1 must first be flashed with CircuitPython. You can find instructions for this <a href="https://docs.sensebox.de/en/docs/editors/circuitpython/circuitpython_esp32">here</a>.</p>
