...
<p>To program the sensor with CircuitPython, the senseBox MCU-S2 must first be flashed with CircuitPython. You can find instructions for this <a href="https://sensebox.de/docs/category/circuitpython">here</a>.</p>

<h3>Software Library</h3>

<p>Download the <a href="https://github.com/adafruit/Adafruit_CircuitPython_BME680/releases/download/3.7.13/adafruit-circuitpython-bme680-10.x-mpy-3.7.13.zip">BME680 CircuitPython library</a>. Extract the .zip file and copy the <code>adafruit_bme680.mpy</code> file from the <code>lib</code> folder into the <code>lib</code> folder of your senseBox (<code>CIRCUITPY</code> drive).</p>

<h3>Code</h3>

<p>Using the CircuitPython editor of your choice, you can now program the sensor and read its values. This code outputs the temperature, gas resistance, relative humidity, air pressure, and altitude in the console:</p>
...
> - [Shop](https://sensebox.kaufen/products/bme)
