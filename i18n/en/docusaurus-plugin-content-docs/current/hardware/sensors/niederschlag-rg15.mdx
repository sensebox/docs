...
This adapter board is included in the sensor package and is connected to the senseBox using the {useBoardStore((state) => (state.board === 'MCU-S2' || state.board === ':edu S2') ? <a href="https://sensebox.kaufen/products/qwiic-kabel-500mm">QWIIC cable SB-074</a> : <a href="https://sensebox.kaufen/products/sensebox-kabel-jst-phr4-500mm">senseBox cable SB-057</a>)}.
