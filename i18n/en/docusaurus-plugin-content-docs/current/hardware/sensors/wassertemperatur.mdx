...
:::warning
To use the sensor with the senseBox you need the 1-Wire adapter. You can purchase it [here](https://sensebox.kaufen/products/sensebox-one-wire-adapter-fur-wasserthermometer).
:::
