...
<p>To program the sensor with CircuitPython, the senseBox MCU-S2 must first be flashed with CircuitPython. You can find instructions <a href="https://docs.sensebox.de/docs/misc/circuitpython_esp32">here</a>.</p>
