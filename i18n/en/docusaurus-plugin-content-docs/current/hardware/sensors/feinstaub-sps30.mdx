...
<p>Download the <a href="https://github.com/kgalb01/Adafruit_CircuitPython_SPS30/releases/download/0.0.2/adafruit-circuitpython-sps30-10.x-mpy-0.0.2.zip">SPS30 CircuitPython library</a>. Unzip the .zip file and copy the <code>adafruit_sps30</code> folder from the <code>lib</code> folder into the <code>lib</code> folder of your senseBox (<code>CIRCUITPY</code> drive).</p>
