...
<p>To program the display with CircuitPython, the senseBox MCU-S2 must first be flashed with CircuitPython. You can find instructions <a href="https://docs.sensebox.de/en/docs/editors/circuitpython/circuitpython_esp32">here</a>.</p>
