...
If none of these steps help, please email us at kontakt@reedu.de. When contacting support, please provide the following information:
...
## App cannot connect to senseBox:bike:
...
## The app does not start track recording (there is no sensor data or tracks on the map).
...
## The app records tracks locally, but does not upload them to openSenseMap.
...
## Not all sensor data is being recorded.
