---
sidebar_position: 8
title: "CircuitPython Example"
description: Brick Breaker game using CircuitPython on the senseBox MCU-S2
---
...
<ImageWithText
  ...
  alt="Brick Breaker game on the OLED display"
  title="Brick Breaker on the senseBox MCU-S2"
/>

<AlertBox type="info">
A detailed step-by-step guide can be found on the <a href="https://sensebox.de/projects/de/2025-10-09-brick-breaker">project page</a>.
</AlertBox>
...
<ImageWithText
  ...
  alt="Setup for the Brick Breaker game"
  title="Setup for the Brick Breaker game"
/>
...
<ImageWithText
  ...
  alt="Control of the Brick Breaker game using the built-in gyroscope"
...
## Further Information
This game demonstrates what is possible with CircuitPython on the senseBox MCU-S2. You can expand the code to add more features, such as scores, levels, or sound effects.
If you just want to try it out, you can also download the ready-to-use version from the <a href="https://github.com/sensebox/MCU-S2-circuitpython-examples/tree/main/examples/brick%20breaker">GitHub repository</a> and copy it directly to your senseBox.